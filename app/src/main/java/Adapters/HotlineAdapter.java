...
public class HotlineAdapter extends FirestorePagingAdapter<RecyclerViewDataModel, HotlineAdapter.RelaxationViewHolder> {
     ...
     * @param options
     */
    public HotlineAdapter(@NonNull FirestorePagingOptions<RecyclerViewDataModel> options, FirestoreViewPagerInterface firestoreRecyclerViewInterface) {
        super(options);
    ...
    public RelaxationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.hotlines_items, parent, false);
    ...
    public class RelaxationViewHolder extends RecyclerView.ViewHolder{
        ...
        public RelaxationViewHolder(@NonNull View itemView) {
            ...
            title = itemView.findViewById(R.id.hotlineUnit);
            subtitle = itemView.findViewById(R.id.hotlineNumber);
            image = itemView.findViewById(R.id.hotlineImage);
