...
public class ViewPagerAdapter3 extends RecyclerView.Adapter<ViewPagerAdapter3.ViewHolder> {
    ...
    public ViewPagerAdapter3(ArrayList<CategoriesPagerModel> dataholder) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewpager_items3, parent, false);
