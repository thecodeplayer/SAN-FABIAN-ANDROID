...
public class FragmentAdjectives extends Fragment implements RecyclerViewInterface {

    private RecyclerView recyclerView;
    private WordsAdapter wordsAdapter;
    private List<DictionaryModel> dictionaryModelList;
    private DatabaseHelper mDBHelper;
    private View adjectives;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        adjectives = inflater.inflate(R.layout.dictionary_layout, container, false);
        recyclerView = adjectives.findViewById(R.id.recyclerviewWord);
        searchView = adjectives.findViewById(R.id.searchView);

        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));

        dictionaryModelList = mDBHelper.adjectiveWords("");
    ...
    private void searchWord(String wordSearch) {
        ...
        dictionaryModelList = mDBHelper.adjectiveWords(wordSearch);
        wordsAdapter.setData(dictionaryModelList, this);
        recyclerView.setAdapter(wordsAdapter);
    }
