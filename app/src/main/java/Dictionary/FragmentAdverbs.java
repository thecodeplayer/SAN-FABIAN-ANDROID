...
public class FragmentAdverbs extends Fragment implements RecyclerViewInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        adverb = inflater.inflate(R.layout.dictionary_layout, container, false);
        recyclerView = adverb.findViewById(R.id.recyclerviewWord);
        searchView = adverb.findViewById(R.id.searchView);

        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));

        dictionaryModelList = mDBHelper.adverbWords("");
    ...
    private void searchWord(String wordSearch) {
        ...
        dictionaryModelList = mDBHelper.adverbWords(wordSearch);
        wordsAdapter.setData(dictionaryModelList, this);
        recyclerView.setAdapter(wordsAdapter);
    }
