...
public class FragmentPronouns extends Fragment implements RecyclerViewInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dictionaryModelList = mDBHelper.pronounWords("");
    ...
    private void searchWord(String wordSearch) {
        ...
        dictionaryModelList = mDBHelper.pronounWords(wordSearch);
        wordsAdapter.setData(dictionaryModelList, this);
        recyclerView.setAdapter(wordsAdapter);
    }
