...
public class FragmentPublicNotices extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        notices = inflater.inflate(R.layout.dictionary_second_layout, container, false);
        recyclerView = notices.findViewById(R.id.recyclerviewWord);

        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));

        dictionarySecondModelList = mDBHelper.noticesWords();
