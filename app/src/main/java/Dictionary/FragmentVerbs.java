...
public class FragmentVerbs extends Fragment implements RecyclerViewInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        verbs = inflater.inflate(R.layout.dictionary_layout, container, false);
        recyclerView = verbs.findViewById(R.id.recyclerviewWord);
        searchView = verbs.findViewById(R.id.searchView);

        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));

        dictionaryModelList = mDBHelper.verbWords("");
    ...
    private void searchWord(String wordSearch) {
        ...
        dictionaryModelList = mDBHelper.verbWords(wordSearch);
        wordsAdapter.setData(dictionaryModelList, this);
        recyclerView.setAdapter(wordsAdapter);
    }
