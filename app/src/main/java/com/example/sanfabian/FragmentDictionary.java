...
public class FragmentDictionary extends Fragment implements RecyclerViewInterface {
    ...
    public void onItemClick(int position) {
        ...
        if (position == 0) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentCommonWords()).addToBackStack(null).commit();
        }
        if (position == 1) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentNouns()).addToBackStack(null).commit();
        }
        if (position == 2) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentAdjectives()).addToBackStack(null).commit();
        }
        if (position == 3) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentPronouns()).addToBackStack(null).commit();
        }
        if (position == 4) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentConjunctions()).addToBackStack(null).commit();
        }
        if (position == 5) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentVerbs()).addToBackStack(null).commit();
        }
        if (position == 6) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentAdverbs()).addToBackStack(null).commit();
        }
        if (position == 7) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentPrepositions()).addToBackStack(null).commit();
        }
        if (position == 8) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentPoliteGreetings()).addToBackStack(null).commit();
        }
        if (position == 9) {
            getParentFragmentManager().beginTransaction().replace(R.id.container, new FragmentPublicNotices()).addToBackStack(null).commit();
        }
    }
