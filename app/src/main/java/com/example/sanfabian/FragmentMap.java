...
public class FragmentMap extends Fragment implements OnMapReadyCallback, PermissionsListener, MapboxMap.OnMapLongClickListener {
    ...
    private FloatingActionButton floatingRemoveMarker;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        floatingRemoveMarker = getActivity().findViewById(R.id.floatingRemoveMarker);
        ...
        searchBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        .accessToken(getActivity().getString(R.string.access_token))
        ...
        floatingRemoveMarker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                startNavigating.setEnabled(false);
                lastSelectedDirectionsProfile = DirectionsCriteria.PROFILE_DEFAULT_USER;
                drivingButton.setTextColor(Color.WHITE);
